...
fluidPage(
	...
	HTML('&emsp;'),
	a('About DORM', href="https://eleniuslabtools.utu.fi/main/docs/DORM.html",style='color:#EE5F21',target="_blank"),
	HTML('&emsp;'),
	a('DORM-Residues', href="https://eleniuslabtools.utu.fi/tools/DORM/Residues/",style='color:#EE5F21'),
	HTML('&emsp;'),
